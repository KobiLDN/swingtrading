window.ANALYSIS_DATA = {
  ...
  "invalidation": "A bullish setup would be invalidated if price fails to close above 1.3340 within two sessions; a bearish setup would be invalidated if price holds above 1.3300 and produces a bullish engulfing pattern.",
  "support_levels": [
    1.33,
    1.325,
    1.32
